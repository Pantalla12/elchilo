...
<center>
		<div id="oficial">
			<legend>Registrar datos del oficial</legend><br>
			<form method="POST" action="PHP/Reg_oficial.php">
			...
			<label id="label_user" style="padding-right:60px;">Id del oficial</label>
                ...
                <input id="input_text_formularios" type="date" name="fecha"  size="40"/><br><br> 
				...
				<legend>Tipo de usuario</legend>
  				...
  				<input id="radios" type="radio" name="tipo" value="Admin"> Administrador <br>
  				<center></fieldset> <br><br>
                <input id="btn_entrar" type="submit" name="guardar" value="Registrar" />    <input id="btn_limpiar"type="reset" name="limpiar" value="Limpiar" />
            </center>
